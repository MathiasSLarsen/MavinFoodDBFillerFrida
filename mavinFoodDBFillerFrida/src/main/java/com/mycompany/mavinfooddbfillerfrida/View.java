...
public class View extends javax.swing.JFrame {
    ...
    public View() throws IOException {
        xml.Makeobjects();
        savePoint = save.load();
        subject = xml.getSubjectArray().get(savePoint);
        initComponents();
        setTextArea();
        setModel();
    }
    ...
    private void setTextArea(){
        ...
        this.jTextArea1.append(subject.biogeneamines.toString());
    ...
    private void uploadButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_uploadButtonActionPerformed
        ...
        if(subject.getIsIngredient() == true){
            try {
                ...
                dto.uploadMonounsaturatedfattyacids(subject.monounsaturatedFattyAcids.getC141n5(), subject.monounsaturatedFattyAcids.getC151(), subject.monounsaturatedFattyAcids.getC161n7(), subject.monounsaturatedFattyAcids.getC171n7(), subject.monounsaturatedFattyAcids.getC181n9(), subject.monounsaturatedFattyAcids.getC181n7(), subject.monounsaturatedFattyAcids.getC201n9(), subject.monounsaturatedFattyAcids.getC201n11(), subject.monounsaturatedFattyAcids.getC221n9(), subject.monounsaturatedFattyAcids.getC221n11(), subject.monounsaturatedFattyAcids.getC241n9(), subject.monounsaturatedFattyAcids.getOther(), subject.getIngredient_idIngredient(), subject.getIsIngredient());
                dto.uploadMonounsaturatedfattyacidsTrans(subject.monounsaturatedFattyAcidsTrans.getC141Trans9(), subject.monounsaturatedFattyAcidsTrans.getC161Trans(), subject.monounsaturatedFattyAcidsTrans.getC181TransN9(), subject.monounsaturatedFattyAcidsTrans.getC201Trans(), subject.monounsaturatedFattyAcidsTrans.getC221Trans(), subject.monounsaturatedFattyAcidsTrans.getC182TransUndifferentiated(), subject.getIngredient_idIngredient(), subject.getIsIngredient());
            ...
            try {
                ...
                dto.uploadMonounsaturatedfattyacids(subject.monounsaturatedFattyAcids.getC141n5(), subject.monounsaturatedFattyAcids.getC151(), subject.monounsaturatedFattyAcids.getC161n7(), subject.monounsaturatedFattyAcids.getC171n7(), subject.monounsaturatedFattyAcids.getC181n9(), subject.monounsaturatedFattyAcids.getC181n7(), subject.monounsaturatedFattyAcids.getC201n9(), subject.monounsaturatedFattyAcids.getC201n11(), subject.monounsaturatedFattyAcids.getC221n9(), subject.monounsaturatedFattyAcids.getC221n11(), subject.monounsaturatedFattyAcids.getC241n9(), subject.monounsaturatedFattyAcids.getOther(), subject.getProduct_idproduct(), subject.getIsIngredient());
                dto.uploadMonounsaturatedfattyacidsTrans(subject.monounsaturatedFattyAcidsTrans.getC141Trans9(), subject.monounsaturatedFattyAcidsTrans.getC161Trans(), subject.monounsaturatedFattyAcidsTrans.getC181TransN9(), subject.monounsaturatedFattyAcidsTrans.getC201Trans(), subject.monounsaturatedFattyAcidsTrans.getC221Trans(), subject.monounsaturatedFattyAcidsTrans.getC182TransUndifferentiated(), subject.getProduct_idproduct(), subject.getIsIngredient());
